...
<title>PoKor - Weather / Area Info</title>
...
<div class="container" style="margin-bottom: 50px;">
	...
	<div class="row ">
		...
		<div class="col-md-6 mb-6">
			<label for="search">Information Type</label> <select
		...
		<div class="col-md-6 mb-6">
			...
			<button type="button" class="btn alazea-btn form-control btn-custom"
				id="searchButton" onclick="return getWeatherData();">Search</button>
		</div>
	</div>
	<hr>
	<div class="shop-products-area">
		<div class="row">
			<div class="col-12">
				<div class="card flex-md-row mb-4 shadow-sm h-md-250 imageDiv"
					id="imageResult" style="display: none"></div>
				<div class="card flex-md-row mb-4 shadow-sm h-md-250"
					id="textResult"
					style="padding-left: 20px; padding-top: 20px; display: none"></div>
			</div>
		</div>
	</div>
</div>
